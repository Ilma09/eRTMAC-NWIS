...
sys.path.insert(0, ".")
from src.utils import call_ollama_chat

PAGE_IMAGE = "pages/CLEANDOC_p1_full.png"
MODEL = "qwen2.5vl:3b"
...
def main():
    ...
    start = time.time()
    response = call_ollama_chat(model=MODEL, prompt=PROMPT, image_path=PAGE_IMAGE, num_ctx=8192)
